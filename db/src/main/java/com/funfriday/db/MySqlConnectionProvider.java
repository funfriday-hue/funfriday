...
public class MySqlConnectionProvider implements DatabaseConnectionProvider {
    private static final String DEFAULT_URL = "jdbc:mysql://127.0.0.1:3306/GameData";
    private static final String DEFAULT_USERNAME = "funfriday_app";
    private static final String DEFAULT_PASSWORD = "funfriday_pass";
